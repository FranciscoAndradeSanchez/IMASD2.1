                                        ...
                                        <table cellpadding="3" cellspacing="0" class="tablaComun" width="100%">
                                            <tr>
                                                ...
                                                <td align="left" style="width: 70%">
                                                    <asp:TextBox ID="txtCveCONACYTBuscar" runat="server" MaxLength="20"></asp:TextBox>
		                    ...
		                    <table cellpadding="0" cellspacing="0" style="width: 100%">
		                        <tr>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnDatosGeneralesEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_dg_sel.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnDatosGeneralesEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnInfraestructuraEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_in_rep.gif" OnClick="ibtnInfraestructuraEdt_Click" /></td>
		                ...
		                <td>
		                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		                        <tr>
		                            ...
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnDetalleMontoEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_dm_rep.gif" OnClick="ibtnDetalleMontoEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnDifusionDivulgaEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_dd_rep.gif" OnClick="ibtnDifusionDivulgaEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnVisitasTecnicasEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_vt_rep.gif" OnClick="ibtnVisitasTecnicasEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnSeguimientoEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_sg_rep.gif" OnClick="ibtnSeguimientoEdt_Click" /></td>
		                            <td style="width: 204px; height: 24px">
		                                <asp:ImageButton ID="ibtnAdministrativoEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_ad_rep.gif" OnClick="ibtnAdministrativoEdt_Click" /></td>
		                        </tr>
		                    </table>
		                </td>
		            </tr>
		            <tr>
		                <td>
		                    <table cellpadding="0" cellspacing="0" class="seccionPestanas" style="width: 100%">
		                        <tr>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnEtapasEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_et_rep.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnEtapasEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnProblematicasEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_pr_rep.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnProblematicasEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnParticipantesEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_pa_rep.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnParticipantesEdt_Click" /></td>
		                            <td style="width: 144px; height: 24px">
		                                <asp:ImageButton ID="ibtnEspeciesEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_es_rep.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnEspeciesEdt_Click" /></td>
		                            <td align="left" style="width: 224px; height: 24px">
		                                <asp:ImageButton ID="ibtnEstadosEdt" runat="server" ImageUrl="~/images/aplicacion/pestana_st_rep.gif"
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnEstadosEdt_Click" /></td>
		                        </tr>
		                    </table>
		                </td>
		            </tr>
		            <tr>
		                <td>
		                    <asp:MultiView ID="mviewProyectosEdt" runat="server" ActiveViewIndex="0">
		                        ...
		                        <asp:View ID="viewProblematicasEdt" runat="server">
		                                                    ...
		                                                    <td style="width: 70%">
		                                                        <asp:TextBox ID="txtAvanceGralPVAdd" runat="server"></asp:TextBox><asp:RequiredFieldValidator
		                                                            ...
		                                                            ErrorMessage="Avance general es requerido" ForeColor="">x</asp:RequiredFieldValidator><asp:RegularExpressionValidator
		                                                                ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtObservacionesPGAdd"
		                    ...
		                    <table cellpadding="0" cellspacing="0" class="seccionPestanas" style="width: 100%">
		                                                                    ...
		                                                                    <asp:UpdatePanel ID="updpEdoMpioPVEdt" runat="server" OnPreRender="updpEdoMpioPVEdt_PreRender">
		                                                                        <ContentTemplate>
		                                                                            <table border="0" cellpadding="3" cellspacing="0" width="100%">
		                                                                                <tr>
		                                                                                    <td style="width: 30%">
		                                                                                        Estado</td>
		                                                                                    <td style="width: 70%">
		                                                                                        <asp:DropDownList ID="ddlEstadoPVEdt" runat="server" DataSourceID="odsEstadoPVEdt"
		                                                                            DataTextField="DesEstado" DataValueField="CveEstadoInt" AutoPostBack="True" SelectedValue='<%# Eval("CveEstado") %>' OnSelectedIndexChanged="ddlEstadoPVEdt_SelectedIndexChanged">
		                                                                                        </asp:DropDownList><asp:RangeValidator ID="ravEstadoPVEdt" runat="server" ControlToValidate="ddlEstadoPVEdt"
		                                                                                            ErrorMessage="Indique el estado" ForeColor="" MaximumValue="33" MinimumValue="1"
		                                                                                            Type="Integer">x</asp:RangeValidator>
		                                                                                        <asp:HiddenField ID="hdnEstadoPVEdt" runat="server" Value='<%# Eval("CveEstado") %>' />
		                                                                                        <asp:ObjectDataSource
		                                                                            ...
		                                                                            DataTextField="DesMpio" DataValueField="CveMpio">
		                                                                                        ...
		                                                                                        <asp:HiddenField ID="hdnMpioPVEdt" runat="server" Value='<%# Eval("CveMunicipio") %>' />
		                                                                                        <asp:ObjectDataSource
		                        ...
		                        <asp:View ID="viewSeguimientoEdt" runat="server">
		                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
		                                ...
		                                <tr>
		                                    <td colspan="2"><asp:Panel ID="pnlProyectoAsuntoPTAdd" runat="server" Width="100%" Visible="False">
		                                        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
		                                            <tr>
		                                                <td style="width: 30%">
		                                                    Descripción del asunto</td>
		                                                <td style="width: 70%">
		                                                    <asp:TextBox ID="txtDescAsuntoPTAdd" runat="server" MaxLength="100" Width="400px"></asp:TextBox><asp:RequiredFieldValidator
		                                            ...
		                                            <tr>
		                                                <td style="width: 30%">
		                                                    Estatus</td>
		                                                <td style="width: 70%">
		                                                    <asp:DropDownList ID="ddlEstatusAsuntoPTAdd" runat="server" DataSourceID="odsEstatusAsuntoPTAdd"
		                                            ...
		                                            <tr>
		                                                ...
		                                                <td style="width: 70%">
		                                                    ...
		                                                    <asp:ImageButton ID="ibtnCancelarPTAdd" runat="server" CausesValidation="False"
		                                                                    ImageUrl="~/images/aplicacion/btnCancelar.gif" OnClick="ibtnCancelarPTAdd_Click" /></td>
		                                            </tr>
		                                        </table>
		                                        &nbsp;</asp:Panel>
		                                    </td>
		                                ...
		                                <tr>
		                                            ...
		                                            <ItemTemplate>
		                                                <table border="0" cellpadding="3" cellspacing="0" class="tablaComun" width="100%">
		                                                    <tr>
		                                                        ...
		                                                        <td style="width: 16%" align="right">
		                                                            <asp:Label ID="lblEstatusPTItm" runat="server" Text='<%# Eval("Estatus") %>'></asp:Label></td>
		                                                        <td style="width: 16%">
		                                    ...
		                                    PostBackUrl="~/RegistroProyectos.aspx" OnClick="ibtnProyectAsuntoOficioPAOEdt_Click" /></td>
		                                            ...
		                                            SelectMethod="GetDataByCveProyecto" TypeName="dsAppTableAdapters.ProyectoAsuntosTableAdapter">
		                                            <SelectParameters>
		                                                <asp:ControlParameter ControlID="lblCveCONACYTEdt" Name="CveProyecto" PropertyName="Text"
		                                                    Type="String" />
		                                            </SelectParameters>
		                                        ...
		                                        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
		                                            <tr>
		                                                <td style="width: 30%">
		                                                    Etapa</td>
		                                                <td style="width: 70%">
		                                                    <asp:TextBox ID="txtCveEtapaAdd" runat="server" Width="25px" EnableViewState="false"></asp:TextBox>
		                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ID="rfvCveEtapaAdd" ControlToValidate="txtCveEtapaAdd" ErrorMessage="Etapa es un campo obligatorio" />
		                                                    <asp:RegularExpressionValidator runat="server" Display="Dynamic" ID="revCveEtapaAdd" ControlToValidate="txtCveEtapaAdd" ErrorMessage="Etapa es un campo estrictamente numérico" ValidationExpression="[0-9]*" />
		                                                </td>
		                                            </tr>
		                                            <tr>
		                                                <td style="width: 30%">
		                                                    Título</td>
		                                                <td style="width: 70%">
		                                                    <asp:TextBox ID="txtTituloAdd" runat="server" EnableViewState="false" ></asp:TextBox>
		                                        ...
		                                        <table border="0" cellpadding="3" cellspacing="0" class="tablaComun" width="100%">
		                                            <tr>
		                                                ...
		                                                <td style="width: 16%" align="left">
		                                                    <asp:Label ID="lblMontoPGItm" runat="server" Text='<%# Eval("CveEtapa") %>'></asp:Label></td>
		                                                <td style="width: 16%">
		                                                    <asp:ImageButton ID="ibtnEliminarPGItm" runat="server" CommandName="Delete" ImageUrl="~/images/aplicacion/btnEliminar.gif" CausesValidation="false" /></td>
		                                            </tr>
		                                        </table>
		                                    </ItemTemplate>
		                                    <EditItemTemplate>
		                                        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
		                                            <tr>
		                                                <td style="width: 30%">
		                                                    Etapa</td>
		                                                <td style="width: 70%">
		                                                    <asp:TextBox ID="txtCveEtapa" runat="server" Width="25px" Text='<%# Eval("CveEtapa") %>'></asp:TextBox>
		                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ID="rfvCveEtapaEdt" ControlToValidate="txtCveEtapa" ErrorMessage="Etapa es un campo obligatorio" />
		                                                    <asp:RegularExpressionValidator runat="server" Display="Dynamic" ID="revCveEtapaEdt" ControlToValidate="txtCveEtapa" ErrorMessage="Etapa es un campo estrictamente numérico" ValidationExpression="[0-9]*" />
		                                                </td>
		                                            </tr>
		                                            <tr>
		                                                <td style="width: 30%">
		                                                        ...
		                                                        ExpandButtonImage="~/images/aplicacion/show-calendar1.gif"  />
		                                                                        ...
		                                                                        <tr>
		                                                                            <td style="width: 30%">
		                                                                                Archivo *</td>
		                                                                            <td style="width: 70%">
		                                                                                <asp:FileUpload ID="flupArchivoPEPAdd" runat="server" Width="350px" /><asp:RegularExpressionValidator
		                                                                                    ID="revArchivoPEPAdd" runat="server" ControlToValidate="flupArchivoPEPAdd" ErrorMessage="Archivo tiene caracteres no permitidos"
		                                                                                    ForeColor="" ToolTip="Archivo tiene caracteres no permitidos" ValidationExpression="^[0-9a-zA-ZñÑÁáÉéÍíÓóÚúÜü/°\s!\x22\#\$%\x26'()*\+,\-.¿?¡:;_\\\d\n]{0,}$">x</asp:RegularExpressionValidator><asp:CustomValidator
		                                                                                        ID="cuvArchivoPEPAdd" runat="server" ControlToValidate="flupArchivoPEPAdd" ForeColor="">x</asp:CustomValidator></td>
		                                                                        </tr>
		                                                                        <tr>
		                                                                            <td style="width: 30%">
		                                                                            </td>
		                                                                        ...
		                                                                        <table border="0" cellpadding="3" cellspacing="0" class="tablaAlternatigTemplate" width="100%">
		                                                                            <tr>
		                                                                                <td style="width: 16%">
		                                                                                    <asp:ImageButton ID="ibtnEditarPEPItm" runat="server" CommandName="Edit" ImageUrl="~/images/aplicacion/btnEditar.gif" /></td>
		                                                                                <td style="width: 34%">
		                                                                                    &nbsp;<asp:Label ID="lblTituloPEPItm" runat="server" Text='<%# Eval("Titulo") %>'></asp:Label>
		                                                                                </td>
		                                                                                <td style="width: 34%">
		                                                                                    <asp:Label ID="lblTipoProductoPEPItm" runat="server" Text='<%# Eval("TipoProducto") %>'></asp:Label></td>
		                                                                                <td style="width: 16%">
		                                    ...
		                                    <td colspan="2">
		                                            ...
		                                            <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
		                                                ...
		                                                <tr>
		                                                    ...
		                                                    <td style="width: 70%; height: 30px;">
		                                                        <asp:TextBox ID="txtMontoInfraPIAdd" runat="server" MaxLength="100" Width="150px"></asp:TextBox><asp:RegularExpressionValidator
		                                                            ID="revMontoPIAdd" runat="server" ControlToValidate="txtMontoInfraPIAdd" ErrorMessage="Nombre del proyecto tiene caracteres no permitidos"
		                                                            ForeColor="" ToolTip="Nombre común tiene caracteres no permitidos" ValidationExpression="^[0-9]{0,}[.][0-9]{0,}$">x</asp:RegularExpressionValidator><asp:RequiredFieldValidator
		                                                                ID="rfvMontoPIEdt" runat="server" ControlToValidate="txtMontoInfraPIAdd" ErrorMessage="El monto de infraestructura es un valor requerido"
		                                        ...
		                                        <asp:DataList ID="dtlInfraestructuraPI" runat="server" DataKeyField="CveInfraestructura" DataSourceID="odsInfraestructuraPI" Width="100%" OnCancelCommand="dtlInfraestructuraPI_CancelCommand" OnDeleteCommand="dtlInfraestructuraPI_DeleteCommand" OnEditCommand="dtlInfraestructuraPI_EditCommand" OnItemDataBound="dtlInfraestructuraPI_ItemDataBound" OnUpdateCommand="dtlInfraestructuraPI_UpdateCommand">
		                                            ...
		                                            <EditItemTemplate><table width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaEditarTemplate">
		                                                <tr>
		                                                    <td colspan="2">
		                                                        <asp:UpdatePanel ID="updpTipoInfraestructuraPIEdt" runat="server" OnPreRender="updpTipoInfraestructuraPIEdt_PreRender">
		                                                            <ContentTemplate>
		                                                                <table width="100%">
		                                                                    <tr>
		                                                                        <td style="width: 30%">
		                                                                            Tipo de Infraestructura</td>
		                                                                        <td style="width: 70%">
		                                                                            <asp:DropDownList ID="ddlTipoInfraestructuraPIEdt" runat="server" DataSourceID="odsTipoInfraestructuraPIEdt"
		                                                                    DataTextField="TipoInfraestructura" DataValueField="CveTipoInfraestructura" OnSelectedIndexChanged="ddlTipoInfraestructuraPIEdt_SelectedIndexChanged">
		                                                                            </asp:DropDownList><asp:RangeValidator ID="ravTipoInfraestructuraPIEdt" runat="server"
		                                                                                ControlToValidate="ddlTipoInfraestructuraPIEdt" ErrorMessage="Debe seleccionar un tipo de infraestructura"
		                                                                                ForeColor="" MaximumValue="1000000" MinimumValue="1" ToolTip="Debe seleccionar un tipo de infraestructura"
		                                                                                Type="Integer">x</asp:RangeValidator><asp:CustomValidator ID="cuvTipoInfraestructuraPIEdt"
		                                                                                    runat="server" ControlToValidate="ddlTipoInfraestructuraPIEdt" ForeColor="">x</asp:CustomValidator>
		                                                                            <asp:HiddenField ID="hdnTipoInfraestructuraPIEdt" runat="server" Value='<%# Eval("CveTipoInfraestructura") %>' />
		                                                                            <asp:ObjectDataSource
		                                                                    ...
		                                                                    <tr>
		                                                                        <td style="width: 30%">
		                                                                            Infraestrucura</td>
		                                                                        <td style="width: 70%">
		                                                                            <asp:DropDownList ID="ddlInfraestructuraPIEdt" runat="server" DataSourceID="odsInfraestructuraPIEdt"
		                                                                    DataTextField="Infraestructura" DataValueField="CveInfraestructura">
		                                                                            </asp:DropDownList><asp:RangeValidator ID="ravInfraestructuraPIEdt" runat="server"
		                                                                                ControlToValidate="ddlInfraestructuraPIEdt" ErrorMessage="Debe seleccionar una infraestructura"
		                                                                                ForeColor="" MaximumValue="1000000" MinimumValue="1" ToolTip="Debe seleccionar una infraestructura"
		                                                                                Type="Integer">x</asp:RangeValidator>
		                                                                            <asp:HiddenField ID="hdnInfraestructuraPIEdt" runat="server" Value='<%# Eval("CveInfraestructura") %>' />
		                                                                            <asp:ObjectDataSource
		                                                                    ID="odsInfraestructuraPIEdt" runat="server" OldValuesParameterFormatString="original_{0}"
		                                                                    SelectMethod="GetDataByTipoInfraestructura" TypeName="dsAppTableAdapters.spInfraestructura_SelectDDLTableAdapter">
		                                                                                    <SelectParameters>
		                                                                                        <asp:ControlParameter ControlID="ddlTipoInfraestructuraPIEdt" Name="CveTipoInfraestructura"
		                                                                                            PropertyName="SelectedValue" Type="Int32" />
		                                                                                    </SelectParameters>
		                                                                                </asp:ObjectDataSource>
		                                                                        </td>
		                                                ...
		                                                <tr>
		                                                    ...
		                                                    <td style="width: 70%">
		                                                        <asp:ImageButton ID="ibtnGuardarPIEdt" runat="server" ImageUrl="~/images/aplicacion/btnGuardar.gif" />
		                                                        <asp:ImageButton ID="ibtnCancelarPIEdt" runat="server" CausesValidation="False"
		                                        ...
		                                        </asp:DataList><asp:ObjectDataSource ID="odsInfraestructuraPI" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByCveProyecto"
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:DataList ID="dtlProductosST" runat="server" DataKeyField="CveProducto"
                                    DataSourceID="odsProductosST" Width="90%" OnItemCommand="dtlProductosST_ItemCommand">
                                    <AlternatingItemTemplate>
                                        <table id="qpLVC" width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaAlternatigTemplate" align="center">
                                            <tr>
                                                <td width="50%">
                                                    <asp:Label ID="lblProductoItm" runat="server" Text='<%# Eval("Producto") %>'></asp:Label></td>
                                                <td width="50%">
                                                    <asp:LinkButton ID="lnkbTituloItm" runat="server" CommandArgument='<%# Eval("CveProyecto") & "," & Eval("CveEtapa") & "," & Eval("CveProducto") & "," & Eval("Ubicacion") %>'
                                    ...
                                    <ItemTemplate>
                                        <table id="qoLVC" width="100%" border="0" cellpadding="3" cellspacing="0" class="tablaItemTemplate" align="center">
                                            <tr>
                                                <td width="50%">
                                                    <asp:Label ID="lblProductoItm" runat="server" Text='<%# Eval("Producto") %>'></asp:Label></td>
                                                <td width="50%">
