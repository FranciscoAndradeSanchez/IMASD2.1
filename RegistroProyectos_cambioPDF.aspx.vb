        ...
        If (Session(System.Web.Configuration.WebConfigurationManager.AppSettings("SesionCampoUsuario").ToString) IsNot Nothing) Then
            Select Case CInt(Session(System.Web.Configuration.WebConfigurationManager.AppSettings("SesionCampoNivel").ToString))
                Case clsAuthentication.AuthorizationLevelList.Administering
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDatosGeneralesEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEtapasEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnProblematicasEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnParticipantesEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEspeciesEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEstadosEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).Enabled = True
                Case clsAuthentication.AuthorizationLevelList.Financial
                    ...
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDatosGeneralesEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEtapasEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnProblematicasEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnParticipantesEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEspeciesEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEstadosEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDetalleMontoEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDifusionDivulgaEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).Enabled = True
                Case clsAuthentication.AuthorizationLevelList.LimitedUpdating
                    ...
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnVisitasTecnicasEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnSeguimientoEdt"), ImageButton).Enabled = True
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnAdministrativoEdt"), ImageButton).Enabled = False
                Case clsAuthentication.AuthorizationLevelList.Consulting
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnDatosGeneralesEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEtapasEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnProblematicasEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnParticipantesEdt"), ImageButton).Enabled = False
                    CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnEspeciesEdt"), ImageButton).Enabled = False
...
#Region "Proyectos"
    ...
    Protected Sub dtlProyectos_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs) Handles dtlProyectos.UpdateCommand
        ...
        Try
            ...
            taProyecto.Update( _
                ...
                dtlProyectos.DataKeys(e.Item.ItemIndex).ToString)
            dtlProyectos.EditItemIndex = -1
            dtlProyectos.DataBind()
    ...
    Protected Sub ibtnCancelarAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        dtlProyectos.EditItemIndex = -1
        dtlProyectos.DataBind()
        ClearFieldAdding()
   ...
   e.Item.ItemType = ListItemType.AlternatingItem Then
    ...
    Protected Sub ibtnActualizarAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnActualizarAdd.Click
        ...
        Catch dataEx As DataException
            ...
            cuvExcepcionesAdd.IsValid = False
        Catch ex As Exception
            cuvExcepcionesAdd.ErrorMessage = "Ocurrió un error al intentar guardar"
    ...
    Protected Sub ibtnDatosGeneralesEdt_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("ibtnProblematicasEdt"), ImageButton).ImageUrl = "~/images/aplicacion/pestana_pr_rep.gif"
...
#Region "ProyectoProgramaPago"
    ...
    Protected Sub dtlProyectoProgPagoPG_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            'taProyectoProgPago.Delete(dtlProyectos.DataKeys(dtlProyectos.EditItemIndex), CType(source, DataList).DataKeys(e.Item.ItemIndex))
            taProyectoProgPago.Delete(CType(source, DataList).DataKeys(e.Item.ItemIndex))
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("pnlProgramaPagoPPAdd"), Panel).Visible = False
            LimpiarProgramaPago()
            CType(source, DataList).DataBind()
        Catch concurrencyEx As DBConcurrencyException
        ...
        Catch dataEx As DataException
            ...
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("cuvMontosPGAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("cuvMontosPGAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:014"
    ...
    Protected Sub dtlProyectoProgPagoPG_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taAdministrativoPagos.Update( _
                CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("lblCveDocumento"), Label).Text, _
                Convert.ToInt32(CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("txtCveEtapa"), TextBox).Text), _
                CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("txtTitulo"), TextBox).Text)
    ...
    Protected Sub ibtnGuardarPGAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Dim taProgramaPago As New dsAppTableAdapters.spAdministrativoPagosTableAdapter
        Dim objChorizoFile_FileUpload As Object = CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("flupPagosAdd"), FileUpload)
        ...
        End If
        Try
            taProgramaPago.Insert( _
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("lblCveCONACYTEdt"), Label).Text, _
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("txtCveEtapaAdd"), TextBox).Text, _
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("txtTituloAdd"), TextBox).Text, _
            "~/Productos/" & CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("flupPagosAdd"), FileUpload).FileName)
    ...
    Protected Sub dtlProyectoVisitasPV_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoVisita.ActualizarVisitaTecnica( _
                ...
                CType(CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("updpEdoMpioPVEdt"), UpdatePanel).FindControl("ddlMpioPVEdt"), DropDownList).SelectedValue, _
    ...
    Protected Sub ibtnGuardarPVAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            taProyectoVisita.InsertarVisitaTecnica( _
                ...
                CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("updpEdoMpioPVAdd"), UpdatePanel).FindControl("ddlMpioPVAdd"), DropDownList).SelectedValue, _
...
#Region "ProyectoEtapa"
    ...
    Protected Sub dtlEtapasPET_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoEtapa.ActualizarEtapa( _
                ...
                CDate(CType(CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("updpFechaTermPETEdt"), UpdatePanel).FindControl("dtpkFechaInicioPETEdt"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
    ...
    Protected Sub ibtnGuardarPETAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Catch dataEx As DataException
            ...
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).IsValid = False
        Catch ex As Exception
            CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("cuvNumEtapaPETAdd"), CustomValidator).ErrorMessage = "Ocurrió un error al intentar guardar clave:035"
...
#Region "ProyectoEtapaProducto"
    ...
    Protected Sub dtlProyectoEtapaProductoPEP_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            ...
            For Each drProductos As dsApp.EtapaProductosRow In dtProyectoEtapaProducto.Rows
                'Eliminar el archivo PDF relacionado al producto
    ...
    Protected Sub ibtnGuardarPEPAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            Dim temp As FileUpload = CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload)
            If CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).HasFile Then
                Dim strExtArchivo As String
                Dim strExtPermitidas As String() = {".pdf"}
                Dim bolExtPermitida As Boolean = False
                strExtArchivo = System.IO.Path. _
                    GetExtension(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName).ToLower()
                For Each strExtPermitida As String In strExtPermitidas
                    bolExtPermitida = (strExtPermitida = strExtArchivo)
                Next
                If bolExtPermitida Then
                    'Aquí entra el Polo (LVC)
                    'Renombrando este chorizo (LVC)
                    Dim objChorizoFile_FileUpload As Object = CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload)
                    'Comentando este otro chorizo (LVC)
                    'If CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileBytes.Length <= CInt(System.Web.Configuration.WebConfigurationManager.AppSettings("MaxBytesArchivo").ToString) Then
                    'Para escribirlo en menos palabras (LVC)
                    'Y añadiendo algunos comentarios (LVC)
                    'Comentario: Verificando que el archivo no exceda el límite de tamaño permitido, establecido en la bandera "MaxBytesArchivo" del web.config (LVC)
                    If objChorizoFile_FileUpload.FileBytes.Length <= CInt(System.Web.Configuration.WebConfigurationManager.AppSettings("MaxBytesArchivo").ToString) Then
                        Try
                            'Comentando este chorizo (LVC)
                            'CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).SaveAs(Server.MapPath(PathProducts) & CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.Substring(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.LastIndexOfAny("\") + 1))
                            'Reescribiéndolo en formas más sutiles (LVC)
                            'Y añadiendo algunos comentarios (LVC)
                            'Si esta fila falla, se sugiere incluir el directorio al cual se quiere hacer la escritura en el mensaje de error... podría no existir o tener deshabilitado el permiso de escritura (LVC)
                            ...
                            NewNameArchivo = "Prod_" & CveProyecto & "_" & CveEtapa.ToString("000") & "_" & Now().ToString("yyyy-MM-dd_hhmmss")
                            ...
                            '******* FIN LUIS RANGEL *************
                        Catch ex As Exception
                            CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = "No fue posible guardar el archivo"
                            CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = "No fue posible guardar el archivo"
                            CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
                            boolAgregarRegistro = False
                        End Try
                        If boolAgregarRegistro Then
                            Try 'Ejecutando desde un bloque TRY-CATCH, en caso de error, se ven los parámetros como Response.Write al principio del documento html (LVC)							
                                'Comentando el insert original para cambiar las 2 primeras variables por otros controles más visibles
                                ...
                                '    "~/Productos/" & CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.Substring(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.LastIndexOfAny("\") + 1))
                                'Cambiando las 2 primeras variables CveEtapa y CveProyecto por las que se visualizan en pantalla

                                '******** LUIS RANGEL 2008/02/05 ******
                                'Cambio las variables del POLO por la mias, para que estas se obtengan de forma directa del enlace de la base de datos
                                'taProyectoEtapaProducto.InsertarProducto( _
                                '    Convert.ToInt32(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("poloCveEtapa"), Label).Text), _
                                '    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("poloCveProyecto"), Label).Text, _
                                '    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtProductoPEPAdd"), TextBox).Text, _
                                '    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("txtTituloPEPAdd"), TextBox).Text, _
                                '    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("chkbEntregadoPEPAdd"), CheckBox).Checked, _
                                '    CDate(CType(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("updpFechaEntPEPAdd"), UpdatePanel).FindControl("dtpkFechaEntPEPAdd"), EclipseWebSolutions.DatePicker.DatePicker).txtDate.Text), _
                            ...
                            Catch basura As Exception
                                ...
                                Response.Write(" 8: " & "~/Productos/" & CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.Substring(CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("flupArchivoPEPAdd"), FileUpload).FileName.LastIndexOfAny("\") + 1))
                            End Try
                        ...
                        End If
                    Else
                        CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible = True
                        CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = String.Format("El tamaño del archivo excede el máximo permitido ({0} KB)", CInt(System.Web.Configuration.WebConfigurationManager.AppSettings("MaxBytesArchivo").ToString) / 1000)
                        CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = String.Format("El tamaño del archivo excede el máximo permitido ({0} KB)", CInt(System.Web.Configuration.WebConfigurationManager.AppSettings("MaxBytesArchivo").ToString) / 1000)
                        CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
                        'Response.Write("aaaaaahh!!")
                        'CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
                    End If
                Else
                    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("pnlProyectoEtapaProductoPEPAdd"), Panel).Visible = True
                    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ErrorMessage = String.Format("El tipo de archivo no esta permitido. Archivos permitidos '*{0}'", strExtPermitidas(0))
                    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).ToolTip = String.Format("El tipo de archivo no esta permitido. Archivos permitidos '*{0}'", strExtPermitidas(0))
                    CType(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).Controls.Item(CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).EditItemIndex + 1).FindControl("cuvProductoPEPAdd"), CustomValidator).IsValid = False
                    'Response.Write("aaaaaahh!!")
                    'CType(dtlProyectos.Controls.Item(dtlProyectos.EditItemIndex).FindControl("dtlEtapasPET"), DataList).DataBind()
                End If
...
#Region "ProyectoInfraestructura"
    ...
    Protected Sub dtlInfraestructuraPI_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        ...
        Try
            taProyectoInfraestructura.Update( _
                dtlProyectos.DataKeys(dtlProyectos.EditItemIndex), _
                CType(source, DataList).DataKeys(e.Item.ItemIndex), _
                CType(CType(source, DataList).Controls.Item(e.Item.ItemIndex + 1).FindControl("txtNumEtapaPETEdt"), TextBox).Text)
            CType(source, DataList).EditItemIndex = -1
            CType(source, DataList).DataBind()
            'odsProyecto.FilterExpression = "CveProyecto = '" + dtlProyectos.DataKeys(dtlProyectos.EditItemIndex) + "'"
            'dtlProyectos.DataBind()
    ...
    Protected Sub ddlTipoInfraestructuraPIEdt_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If (CType(sender, DropDownList).SelectedValue = _
            CType(CType(sender, DropDownList).Parent.Parent.FindControl("hdnTipoInfraestructuraPIEdt"), HiddenField).Value) Then
            CType(CType(sender, DropDownList).Parent.Parent.FindControl("ddlInfraestructuraPIEdt"), DropDownList).DataBind()
            CType(CType(sender, DropDownList).Parent.Parent.FindControl("ddlInfraestructuraPIEdt"), DropDownList).SelectedValue = CType(CType(sender, UpdatePanel).FindControl("hdnInfraestructuraPIEdt"), HiddenField).Value
        Else
            CType(CType(sender, DropDownList).Parent.Parent.FindControl("ddlInfraestructuraPIEdt"), DropDownList).SelectedValue = "-1"
            CType(CType(sender, DropDownList).Parent.Parent.FindControl("hdnInfraestructuraPIEdt"), HiddenField).Value = "-1"
        End If
    End Sub

    Protected Sub updpTipoInfraestructuraPIEdt_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        If (CType(CType(sender, UpdatePanel).FindControl("ddlTipoInfraestructuraPIEdt"), DropDownList).SelectedValue = _
            CType(CType(sender, UpdatePanel).FindControl("hdnTipoInfraestructuraPIEdt"), HiddenField).Value) Then
            CType(CType(sender, UpdatePanel).FindControl("ddlInfraestructuraPIEdt"), DropDownList).DataBind()
            CType(CType(sender, UpdatePanel).FindControl("ddlInfraestructuraPIEdt"), DropDownList).SelectedValue = CType(CType(sender, UpdatePanel).FindControl("hdnInfraestructuraPIEdt"), HiddenField).Value
        Else
            CType(CType(sender, UpdatePanel).FindControl("ddlInfraestructuraPIEdt"), DropDownList).SelectedValue = "-1"
            CType(CType(sender, UpdatePanel).FindControl("hdnInfraestructuraPIEdt"), HiddenField).Value = "-1"
        End If
    End Sub
        ...
        Select Case e.CommandName
            Case "Download"
                ...
                Try
                    ...
                    'Sale el Polo
                    Response.TransmitFile(Server.MapPath(strArchivo(3)))
                    Response.End()
                    taEtapaProducto.AgregarDescarga(strArchivo(0), CInt(strArchivo(1)), CInt(strArchivo(2)))
